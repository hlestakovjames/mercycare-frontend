...
export default function PalliativeComfortCareHero() {
  return (
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 lg:px-8 lg:py-28">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-base leading-8 text-slate-300 sm:text-lg">
            MercyCare provides compassionate home-based support for individuals
            and families navigating serious or advanced care needs, with a
            focus on comfort, dignity, respect, and meaningful time together.
          </p>
