...
export default function FamilyCaregiverSupportHero() {
  return (
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 lg:px-8 lg:py-28">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">
            Supporting the people who support their loved ones.
          </h1>

          <p className="mt-6 max-w-2xl text-base leading-8 text-slate-300 sm:text-lg">
            Caregiving can be demanding for families. MercyCare provides
            practical, compassionate support that helps families navigate
            everyday care while keeping the individual receiving support at the
            center.
          </p>
