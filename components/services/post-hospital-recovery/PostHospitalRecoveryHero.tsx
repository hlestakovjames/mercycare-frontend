...
export default function PostHospitalRecoveryHero() {
  return (
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 lg:px-8 lg:py-28">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-base leading-8 text-slate-300 sm:text-lg">
            MercyCare provides home-based support for individuals adjusting
            after hospitalization or treatment, helping make the transition
            home more organized, comfortable, and supported.
          </p>
