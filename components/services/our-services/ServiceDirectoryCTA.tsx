...
export default function ServiceDirectoryCTA() {
  return (
    <section className="bg-[#0B1B3A] py-16 sm:py-20">
      <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-slate-300">
          You do not have to determine the right service on your own. Contact
          MercyCare and we can begin by understanding your situation.
        </p>
