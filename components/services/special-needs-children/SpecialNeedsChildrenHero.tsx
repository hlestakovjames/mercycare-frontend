...
export default function SpecialNeedsChildrenHero() {
  return (
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 lg:px-8 lg:py-28">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">
            Respectful support for children and the families who care for them.
          </h1>

          <p className="mt-6 max-w-2xl text-base leading-8 text-slate-300 sm:text-lg">
            MercyCare provides compassionate home-based support for children
            with additional care needs, with an approach centered on dignity,
            family involvement, consistency, and the individual child.
          </p>
