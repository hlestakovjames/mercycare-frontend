...
export default function SpecialNeedsChildrenCTA() {
  return (
    <section className="bg-[#0B1B3A] py-16 sm:py-20">
      <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <h2 className="mt-3 text-3xl font-bold tracking-tight text-white sm:text-4xl">
          Let's understand your child's support needs together.
        </h2>

        <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-slate-300">
          Every child and family is different. Start a conversation with
          MercyCare to discuss your circumstances and explore the appropriate
          next steps.
        </p>
