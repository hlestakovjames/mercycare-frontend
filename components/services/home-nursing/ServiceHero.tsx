      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
            Professional nursing support delivered in the comfort and privacy
            of your home, helping individuals and families manage clinical
            needs with confidence and dignity.
          </p>
