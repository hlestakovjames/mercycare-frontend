...
export default function HomeNursingHero() {
  return (
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 lg:px-8 lg:py-28">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">
            Professional care, delivered in the comfort of home.
          </h1>

          <p className="mt-6 max-w-2xl text-base leading-8 text-slate-300 sm:text-lg">
            MercyCare's home nursing service is designed to support individuals
            who need nursing care in a familiar home environment, while helping
            families and caregivers navigate the care journey with confidence.
          </p>
