export default function BlogInterviewsCta() {
  return (
        ...
        <div className="overflow-hidden rounded-3xl bg-cyan-700 px-7 py-12 text-white sm:px-10 lg:px-14">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-bold tracking-tight sm:text-4xl">
              Keep exploring the stories behind the work.
            </h2>

            <p className="mt-4 max-w-2xl leading-7 text-cyan-50">
              Move between interviews, voices, stories, resources and the
              wider MercyCare editorial collection.
            </p>
