...
export default function BlogGetInvolvedHero() {
  return (
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 sm:px-8 lg:px-12 lg:py-28">
        <div className="max-w-4xl">
          <p className="text-sm font-semibold uppercase tracking-[0.22em] text-cyan-300">
            MercyCare Media Center · Get Involved
          </p>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
            Stories become richer when communities, families, caregivers,
            professionals and partners have space to contribute their
            perspectives.
          </p>
