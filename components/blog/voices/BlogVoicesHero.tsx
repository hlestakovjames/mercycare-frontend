export default function BlogVoicesHero() {
  return (
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-28">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-200">
            Discover perspectives from communities, caregivers, professionals,
            partners and the people who make MercyCare's work possible.
          </p>
        </div>
      </div>
    </section>
