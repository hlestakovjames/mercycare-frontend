export default function AwarenessEventsHero() {
  return (
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 sm:px-8 sm:py-24 lg:px-12">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-200 sm:text-xl">
            Community conversations and educational gatherings that encourage
            awareness, understanding, participation and connection to
            appropriate support.
          </p>
        </div>
      </div>
