...
export default function HealthWellnessActivitiesHero() {
  return (
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 sm:px-8 sm:py-24 lg:px-10">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-200 sm:text-xl">
            Community-focused activities that create space for conversations,
            learning, connection and practical engagement around health and
            wellbeing.
          </p>
