...
export default function FamilyCaregiverActivitiesHero() {
  return (
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 sm:px-8 sm:py-24 lg:px-10">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-white sm:text-5xl lg:text-6xl">
            Family &amp; Caregiver Activities
          </h1>

          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-200 sm:text-xl">
            Creating opportunities for families and caregivers to connect,
            learn, share experiences and strengthen the support they provide to
            their loved ones.
          </p>
