      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 sm:px-8 sm:py-24 lg:px-10">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-200 sm:text-xl">
            Creating opportunities for MercyCare to connect with communities,
            listen to their needs and support meaningful conversations around
            wellbeing, dignity and compassionate care.
          </p>
