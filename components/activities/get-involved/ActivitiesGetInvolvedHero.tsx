...
export default function ActivitiesGetInvolvedHero() {
  return (
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 sm:px-8 sm:py-24 lg:px-10">
        <div className="max-w-4xl">
          ...
          <h1 className="text-4xl font-bold leading-tight sm:text-5xl lg:text-6xl">
            There is more than one way to be part of community action.
          </h1>

          <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-200 sm:text-xl">
            Participate in MercyCare activities, contribute your skills,
            support community engagement or connect us with people and
            organisations that can help strengthen our work.
          </p>
