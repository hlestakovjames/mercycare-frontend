...
export default function PastActivitiesHero() {
  return (
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 sm:px-8 sm:py-24 lg:px-10">
        <div className="max-w-4xl">
          ...
          <h1 className="text-4xl font-bold leading-tight sm:text-5xl lg:text-6xl">
            Looking back at activities, participation and community moments.
          </h1>

          <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-200 sm:text-xl">
            This space can document completed MercyCare activities, community
            engagement and lessons from initiatives as the organisation's work
            grows.
          </p>
