...
export default function ProjectAreasCTA() {
  return (
    <section className="bg-slate-50 py-20 lg:py-24">
      <div className="mx-auto max-w-4xl px-6 text-center lg:px-8">
        ...
        <h2 className="mt-4 text-3xl font-bold tracking-tight text-[#0B1B3A] sm:text-4xl">
          Discover the projects behind our community work.
        </h2>

        <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-slate-600">
          Explore MercyCare's project directory to learn about specific
          initiatives and how they translate our broader focus into practical
          community action.
        </p>
